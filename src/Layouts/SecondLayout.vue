<template>
  <div>
    <!-- {/* nav-top*/} -->
    <div
      class="w-100 bgn1-color py-3 position-fixed z-3 top-0 br-bottom-n5 box-shadow1"
    >
      <div class="container d-flex align-items-center justify-content-between">
        <RouterLink to="/" class="side-icon bgn2-color brn4">
          <svg
        ...
        <div class="d-flex gap-3 align-items-center">
          <RouterLink to="/checkout" class="position-relative">
          ...
          <div class="side-icon bg1-color" @click="toggleDark()">
            <span
              v-if="isDark"
              class="dark_btn d-flex justify-content-center align-items-center n11-color"
            >
              <PhMoon weight="fill" />
            </span>
            <span
...
import { PhMoon, PhShoppingCart, PhSun } from "@phosphor-icons/vue";
